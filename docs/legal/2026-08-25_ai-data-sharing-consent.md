...
> `docs/legal/AI_DATA_SHARING_CONSENT.md` (`DOC-2e9fdc06e4`, ATTESTED 2026-08-04 by Scot
> Wahlquist, CEO; first attested 2026-07-09), which remains frozen and byte-identical as the
> signed record. Every attestation statement reproduced below belongs to **predecessor
...
| # | Claim in `AI_DATA_SHARING_CONSENT.md` (attested 2026-08-04) | Correction |
|---|---|---|
