...
**Supersedes:** `docs/legal/BREACH_RUNBOOK.md` (register `DOC-d4e3b8be32`), which remains frozen at the v2.2.1 bytes attested 2026-08-01 (`2b788387259bc315fc4b1e5a10817f55ae2d9eae02988236b245c5f62ede1907`). **This file is the operative runbook. Use this one during an incident.** The predecessor is retained unaltered as the attested historical record and must not be edited; per `docs/legal/README.md` rules 3 and 4, an attested legal record's bytes, filename, and location are immutable, and content changes go through supersession rather than in-place amendment.
**Attestation:** **Attestation pending.** No signature is recorded here. Only Scot attests, and the register row for this successor carries no `attestedContentHash` until he does. The 2026-08-01 attestation covers the predecessor's v2.2.1 bytes only; it does not extend to this file. Prior attestations on the superseded line: 2026-08-01, 2026-07-31, 2026-07-28, 2026-07-23, 2026-06-21.
