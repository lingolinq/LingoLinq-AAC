...
> `docs/legal/2026-08-09_data-retention_draft.md` (`DOC-e62caf7fb9`), which remains frozen and
> byte-identical. That predecessor was accurate for its date: Render was still a live write-frozen
