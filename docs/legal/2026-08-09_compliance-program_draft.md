...
| Register audited commit | last full `/audit-run`: `d67ed76e0a1` (auditedDate 2026-08-12, 46 new findings); monthly light-run restamp `59f502aa4` (auditedDate 2026-08-18); live counts re-derived at staging HEAD `64cdccba1` plus the two rows added by PR #838 (2026-08-20) for this v1.3 draft |
