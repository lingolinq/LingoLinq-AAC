...
there as enforced **[CORRECTION 2026-09-14: "enforced" there states configured cadence, not execution; production scheduled dispatch was interrupted 2026-07-21 to 2026-09-02 (`LL-3e36a18199`; open when written, verified-closed 2026-09-18, with the interruption impact assessment now carried by `LL-cbc8bc4211`).] [CORRECTION 2026-08-25: the EU 5-year leg is wired but matches zero rows, per the
