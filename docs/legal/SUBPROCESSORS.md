...
| 5 | Google LLC (Gemini API) | Gemini models for AI board generation and word prediction | Pseudonymized (scrubbed) prompts only, redacted by lib/pii_scrubber.rb before transmission; still personal data under GDPR/UK-GDPR | Yes — pseudonymized learner content (direct identifiers removed by design) | US | DPA via Google Cloud Terms of Service and Data Processing Addendum | https://cloud.google.com/terms/data-processing-addendum |
