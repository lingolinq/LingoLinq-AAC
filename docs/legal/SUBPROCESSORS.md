...
**2026-07-23 update:** Cloud TTS Pre-GA `v1beta1` endpoint residual REMEDIATED (PR #667: repointed to GA `v1`, consumer `translate_tts` fallback removed). Abair (#17) DPA-or-disable and the voice-transcription (#18) consent/flag posture remain open CEO decisions; findings stay open pending triage. See change log.
