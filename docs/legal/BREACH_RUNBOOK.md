...
**Attestation:** **Re-attestation pending for v2.2.3.** The 2026-08-01 attestation by Scot Wahlquist, CEO covered the v2.2.1 bytes and the §13 corrections listed there. It does not cover the v2.2.2 correction to §7 made 2026-08-02, and it does not cover the v2.2.3 correction to §7 made 2026-08-15 (see §13). Only Scot attests, so no signature is recorded here and the register still pins the v2.2.1 bytes. Prior attestations: 2026-08-01, 2026-07-31, 2026-07-28, 2026-07-23, 2026-06-21.
