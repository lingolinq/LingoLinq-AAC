...
**Version:** v2.2.1 (2026-07-31)
**Owner:** Privacy Office (privacy@lingolinq.com)
**Last reviewed:** 2026-07-31
**Next review:** 2027-07-31
**Classification:** Internal, share with counsel on demand
**Attestation:** Re-attested 2026-07-31 by Scot Wahlquist, CEO, covering the v2.2.1 corrections in §13. The 2026-07-28 attestation covered the v2.2 bytes (`fbdf49a1...`), which were corrected after that attestation was recorded; this attestation covers the corrected bytes. Prior attestations: 2026-07-28, 2026-07-23, 2026-06-21.
...
- **v2.2.1 (2026-07-31).** Correction release. A senior review of v2.2 conducted after its attestation found three defects, corrected here:
  ...
  - **§4.2 emergency kill list.** v2.2 listed `article_50_disclosure` among the AI features to kill. That flag is the EU AI Act Article 50(1) first-use disclosure, a legally required notice hard-gated to 2026-08-02, and it is not a member of `AI_FEATURES`, so the documented org-scoped kill path did not reach it in any case. Removed, with an explicit do-not-disable caveat, and the actual `AI_FEATURES` member `comprehensive_eval_ai` added in its place.
