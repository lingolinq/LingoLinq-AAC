...
- 2026-09-12: audit note. `codex-review/deep-pass` was made required after the 2026-07-22 smoke, then dropped from protection on every branch during the 2026-08 reviewer outage; no run has dispatched since 2026-08-04. The next smoke happens as step (3) of the revival checklist in `.github/codex/README.md`.
