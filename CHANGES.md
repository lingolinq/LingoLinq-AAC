...
**File:** `Procfile`
**Issue:** Removed `nvm install 18` command, causing deployment failures when Node 18 wasn't pre-installed.
**Fix:** Added `nvm install 18` before `nvm use 18` to ensure Node 18 is always available.
