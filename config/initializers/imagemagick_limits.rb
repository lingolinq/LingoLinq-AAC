...
# total memory spikes past the cgroup limit and the platform kills the entire
...
# required and any override set explicitly in the service env wins.
#
# Defaults sized for the 2 GB worker memory limit (deploy-cloudrun.yml --memory 2Gi): 64MiB x 20 concurrent ~ 1.3 GB,
