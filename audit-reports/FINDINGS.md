...
| LL-2c47df5d21 |  | low | SOC2 | untriaged | manual | SES accepts prod mail but end-to-end delivery to the operator's personal Gmail address is unconfirmed; SPF/DKIM/DMARC/inbox-placement follow-up needed before relying on that address for production alerts or transactional confirmation | (attestation) |
...
_110 findings total. Re-run `ruby scripts/citation-check.rb` to validate every active citation._
