...
**Headline (open + remediated-unverified):** 0 Critical / 21 High
...
| LL-7784f74447 |  | medium | GDPR | untriaged | audit-run | Attested AI Governance Memo justifies deferring the Article 50 gate "because prod carries no real EU users (internal/test accounts only)" without a stated basis | `docs/legal/AI_GOVERNANCE_MEMO.md`:274 |
...
_179 findings total. Re-run `ruby scripts/citation-check.rb` to validate every active citation._
