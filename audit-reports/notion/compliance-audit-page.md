...
**Run date:** 2026-07-08  
**Page generated:** 2026-07-08T15:14:26Z
...
| LL-5e7676187f |  | high |  | indexeddbshim (abandoned upstream) is bundled to production and underlies the offline AAC data sync path | `app/frontend/package.json`:70 |
...
| LL-90045bb29c |  | medium | FERPA | User#user_token is a permanent, non-expiring credential serialized on login and embedded in navigable lesson/board share URLs | `lib/json_api/user.rb`:41 |
