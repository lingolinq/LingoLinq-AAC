  ...
  actions: {
    board_preview: function (board) {
      ...
      if (_this.get('action_override')) {
        ...
        this.modal.board_preview(board, board.preview_locale, this.get('allow_style'), function () {
    ...
    pick_board: function (board) {
      ...
      if (_this.get('noop')) {
        ...
        this.modal.board_preview(board_record, board_record.preview_locale, this.get('allow_style'), function () {
