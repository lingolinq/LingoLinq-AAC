...
export default Component.extend({
  ...
  didInsertElement() {
    ...
    if (this.get('model.button')) {
      ...
      if (times) {
        ...
        this.set('model.button.times', readable_times.join(';'));
      }
      if (places) {
  ...
  actions: {
    ...
    updateModelButtonImage(value) {
      this.set('model.button.image', value);
    },
    updateModelButtonHighlightType(value) {
      this.set('model.button.highlight_type', value);
    },
    updateModelButtonGeos(value) {
      this.set('model.button.geos', value);
    },
    updatePlace(value) {
      this.set('place', value);
    },
    add_ssid() {
      if (this.get('appState.current_ssid')) {
