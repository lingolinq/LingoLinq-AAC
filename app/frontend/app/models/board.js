...
//            boards_hash[idx].find_content_locally();
  ...
  star_or_unstar: function(star) {
    ...
    this.persistence.ajax('/api/v1/boards/' + this.get('id') + '/stars', {
      ...
      this.modal.warning(i18n.t('star_failed', "Like action failed"));
    });
  },
  star: function() {
...
LingoLinq.Board.reopenClass({
  clear_fast_html: function() {
    ...
    if(this.appState.get('currentBoardState.id') && editManager.controller && !editManager.controller.get('ordered_buttons')) {
