...
export default modal.ModalController.extend({
  ...
  actions: {
    ...
    copy: function (code) {
      ...
      this.modal.success(i18n.t('code_copied_to_clipboard', "Code Copied to Clipboard!"));
    },
    back: function () {
      this.set('link_code', null);
    },
    copy_link: function () {
      ...
      this.modal.success(i18n.t('link_copied_to_clipboard', "Link Copied to the Clipboard!"));
    },
    copy_code: function () {
      ...
      if (elem) {
        ...
        this.modal.success(i18n.t('qr_code_copied_to_clipboard', "QR Code Copied to Clipboard!"));
      } else {
