...
export default Controller.extend({
  ...
  hasComponentBasedModal: computed('modalService.currentTemplate', function() {
    ...
    const convertedModals = ['about-lingolinq', 'supervision-settings', 'new-board', 'confirm-delete-board', 'speak-menu', 'support', 'intro', 'terms-agree', 'confirm-update-app', 'download-board', 'share-board', 'set-as-home', 'copying-board', 'confirm-edit-board', 'confirm-needs-copying', 'speak-mode-pin', 'premium-required', 'which-home', 'force-logout', 'switch-languages', 'badge-awarded', 'getting-started', 'add-to-sidebar', 'copy-board', 'find-button', 'board-details', 'speak-mode-intro', 'button-stash', 'board-copies', 'switch-communicators', 'record-note', 'sync-details', 'confirm-notify-user', 'share-utterance', 'share-email', 'edit-board-details', 'approve-board-share', 'importing-recordings', 'importing-boards', 'confirm-remove-board', 'modeling-intro', 'confirm-external-app', 'confirm-external-link', 'download-log', 'add-app', 'add-tool', 'confirm-delete-logs', 'inline-book', 'swap-or-drop-button', 'subscribe', 'inline-video', 'device-settings', 'translation-select', 'swap-images', 'quick-assessment', 'add-supervisor', 'word-data', 'new-goal', 'button-suggestions', 'batch-recording', 'button-settings', 'enable-logging', 'sidebar-button-settings', 'premium-voices', 'modify-core-words', 'button-set', 'board-stats', 'rename-board', 'modals/board-intro', 'modals/board-actions', 'modals/start-codes', 'modals/confirm-delete-user', 'modals/confirm-remove-goal', 'modals/board-privacy', 'modals/gif', 'modals/choose-locale', 'modals/tag-board', 'modals/assign-lesson', 'modals/slice-locales', 'modals/confirm-org-action', 'modals/assessment-settings', 'modals/eval-jump', 'modals/eval-status', 'modals/big-button', 'modals/external-device', 'modals/extra-colors', 'modals/timer', 'modals/paint-level', 'modals/focus-words', 'modals/remote-model', 'modals/modeling-ideas', 'modals/repairs', 'modals/inbox', 'modals/phrases', 'modals/masquerade', 'modals/manual-log', 'modals/importing-logs', 'modals/message-unit', 'modals/note-templates', 'modals/profiles', 'modals/program-nfc', 'modals/push_to_cloud', 'modals/request-supervisee', 'modals/user-status', 'modals/valet-mode'];
