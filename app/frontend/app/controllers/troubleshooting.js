        ...
        if (num == '1') {
          ...
          var check_played = function () {
            if (!played) {
              ...
              if (check_played.count < 20) {
                ...
                _this.modal.error(i18n.t('audio_never_played', "Oops! The audio element never triggered a play event."));
              }
            }
          };
          runLater(check_played, 300);
          ...
          if (window.Audio) {
            ...
            wav_audio.onerror = function (err) {
              ...
              _this.modal.error(i18n.t('audio_test_3_error', "Oops, that one didn't work. Your device might not be able to play back all audio types."));
            };
            wav_audio.onended = function () {
              if (!wav_audio.errored) {
                _this.modal.notice(i18n.t('audio_test_3_success', "You should hear a beeping sound"));
                speecher.beep();
              }
            };
            wav_audio.load();
            ...
            _this.modal.error(i18n.t('audio_class_missing', "Audio class not found"));
          }
          return;
        }
      }
