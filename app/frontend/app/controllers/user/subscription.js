          ...
          progress_tracker.track(data.progress, function (event) {
            if (event.status == 'errored') {
              ...
              user.reload().then(function () {
                ...
                this.modal.success(i18n.t('extras_purchased', "Success! You now have access to premium symbols in %app_name%!"));
              }, function () {
        ...
        this.persistence.ajax('/api/v1/users/' + user.get('user_name') + '/subscription', {
          ...
          progress_tracker.track(data.progress, function (event) {
            if (event.status == 'errored') {
              ...
              this.modal.success(i18n.t('user_subscription_canceled', "Your subscription has been canceled."));
              user.reload().then(function () {
                _this.send('reset');
              });
            }
