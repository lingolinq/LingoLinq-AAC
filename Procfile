...
ember: sh -c 'export NVM_DIR="/usr/local/share/nvm" && [ -s "$NVM_DIR/nvm.sh" ] && . "$NVM_DIR/nvm.sh" && nvm use 18 && cd ./app/frontend/ && npx ember server --port 8184 --proxy http://127.0.0.1:5000'