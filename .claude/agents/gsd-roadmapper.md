...
Reference full template: `/home/tracid/LingoLinq-AAC/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/tracid/LingoLinq-AAC/.claude/get-shit-done/templates/state.md`.
