...
<reference>
@/home/tracid/LingoLinq-AAC/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/tracid/LingoLinq-AAC/.claude/get-shit-done/references/user-profiling.md` to load:
